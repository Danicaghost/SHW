load('/DATA/shihaowei/new/pycharmgive/label/twSR/tweenterSRlabel.mat');
load('/DATA/shihaowei/new/pycharmgive/label/twSR/tweenterSRtest.mat');
test_1 = tweenterSRtest;
...
save_path= '/DATA/shihaowei/new/pycharmgive/tweenter1SR/cca/';
% save_path= 'E:\study\my01\DCAF\CCCASUM\1\CLUT\';
if ~exist(save_path,'dir')
    mkdir(save_path);
end

load('/DATA/shihaowei/new/pycharmgive/tweenter1SR/seresnet50R.mat');
load('/DATA/shihaowei/new/pycharmgive/tweenter1SR/seresnet101R.mat');
load('/DATA/shihaowei/new/pycharmgive/tweenter1SR/seresnet152R.mat');
load('/DATA/shihaowei/new/pycharmgive/tweenter1SR/seresnetxt50R.mat');
load('/DATA/shihaowei/new/pycharmgive/tweenter1SR/seresnetxt101R.mat');
% R152 = resnet152R';
...
new_feature_name = ['cca_' feature_list{1} feature_list{2}];
...
testX = X(:,test_index)';
testY = Y(:,test_index)';
[all,test]=ccaFuse(trainX, trainY,testX,testY, 'concat');
