...
if __name__ == '__main__':
    workbook1 = xlsxwriter.Workbook('./vote/FI/FIVOTING_top3_soft.xlsx')
    workbook2 = xlsxwriter.Workbook('./vote/FI/FIVOTING_top3_soft_avg.xlsx')
    ...
    for gh in range(10):
        ...
        for gx in range(len(test_all)):
            ...
            model = soft_Vot_clf.fit(train_x, train_y)
